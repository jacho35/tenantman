...
function initSchema() {
  const tables = `
    CREATE TABLE IF NOT EXISTS tenants (id INTEGER PRIMARY KEY AUTOINCREMENT, unit_number INTEGER NOT NULL, name TEXT NOT NULL, email TEXT NOT NULL, billing_address TEXT, vat_number TEXT, rental_amount REAL NOT NULL DEFAULT 0, water_meter_id TEXT, elec_meter_id TEXT, has_internet INTEGER NOT NULL DEFAULT 0, has_electricity INTEGER NOT NULL DEFAULT 0, internet_amount REAL NOT NULL DEFAULT 200, is_placeholder INTEGER NOT NULL DEFAULT 0, is_active INTEGER NOT NULL DEFAULT 1, created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')));
